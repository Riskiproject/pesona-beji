...
export default function HeroBerandaPage() {
...
const loadBanners = async () => {
  try {
    const data = await getAllHero("beranda");
    setBanners(data || []);
  } catch (err) {
    console.error(err);
  }
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-500">
            Kelola banner slider yang tampil pada halaman Beranda.
          </p>
...
>
  ...
  <div className="rounded-2xl border border-dashed bg-white py-20 text-center">
    ...
    <p className="mt-3 text-gray-500">
      Silakan tambahkan banner pertama untuk Hero Beranda.
    </p>
